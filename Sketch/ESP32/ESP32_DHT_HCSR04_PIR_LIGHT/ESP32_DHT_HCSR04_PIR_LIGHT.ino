...
#define password ""
#define mqtt_server ""
#define topic_temp "smart-villa/etage1/esp32/temp"
#define topic_hum "smart-villa/etage1/esp32/hum"
#define topic_dist "smart-villa/etage1/esp32/dist"
...
float distance_centimetre() {
  ...
  client.publish(topic_dist, String(distance).c_str(), true);
...
void loop() {
  ...
  #ifdef DHT_SENSOR
  {
    ...
    Serial.print(h);
    client.publish(topic_hum, String(h).c_str(), true); 
    Serial.print(" \t\t");
    Serial.println(t);
